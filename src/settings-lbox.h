#ifndef __ESPUINO_SETTINGS_LBOX_H__
#define __ESPUINO_SETTINGS_LBOX_H__
    #include "Arduino.h"
    ...
    */
    ...
    // GPIOs 16+17 are not available for ESP32-WROVER as they're used to internal purposes (PSRAM).

    #ifndef SD_MMC_1BIT_MODE
        #error SDCard via SPI not supported
    #endif
    ...
    #define RFID_CS                         4           // GPIO for chip select (RFID)
    ...
    // (optinal) Headphone-detection
        ...
        #define HP_DETECT                   12          // GPIO that detects, if there's a plug in the headphone jack or not
    #endif
    ...
    // (optional) Monitoring of battery-voltage via ADC
        ...
        constexpr float offsetVoltage = 0.47;                     // If voltage measured by ESP isn't 100% accurate, you can add an correction-value here
    #endif
