	...
	98: MW's LBox board                     => settings-lbox.h
	...
	*/
		...
		#define HAL 98      // HAL 1 = LoLin32, 2 = ESP32-A1S-AudioKit, 3 = Lolin D32, 4 = Lolin D32 pro; ... 99 = custom
	#endif
	...
	*/
	...
	#define BUTTON_MULTI_01   CMD_DIMM_LEDS_NIGHTMODE
	...
	#elif (HAL == 98)
		#include "settings-lbox.h"                          // Pre-configured settings for MW's LBox board (ESP32-WROVER-E, PN5180, SDMMV)
	#elif (HAL == 99)
